                ...
                <tr>
                  <td width="70%" style="vertical-align: middle; padding-right: 20px;">
                    <div style="font-size: 15px; color: #1e293b; line-height: 1.6;">
                      <strong style="font-size: 16px;">📱 <a href="https://teamrealtyexperts.com/share/0c8d4a0b-37ea-4cdb-b6a9-67fd40091532" style="color: #2563eb; text-decoration: none;">View Full Post on Agent Hub</a></strong>
                  ...
                  <td width="30%" style="vertical-align: middle; text-align: center;">
                    <img src="https://raw.githubusercontent.com/User8888-Level3/RealtyExperts-Daily-Email/main/note-qr-0c8d4a0b.png" alt="Agent Hub QR Code" width="100" style="display: block; margin: 0 auto; max-width: 100px; height: auto;">
                  </td>
                </tr>
              </table>
            </td>
