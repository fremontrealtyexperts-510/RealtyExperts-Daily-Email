...
function economySection(data) {
  ...
  // Optional Market Briefs / chart graphic (e.g. the gold "Looking Dull" chart),
  // shown in the broadcast post as well as the email. Clickable -> full size.
  if (e.feature_image && e.feature_image.url) {
    const fi = e.feature_image;
